(function(){'use strict';
  ...
  var C={
    ...
    'Аксессуары':['Bracer','Null Talisman','Wraith Band','Magic Wand','Soul Ring','Orb of Corrosion','Falcon Blade','Perseverance','Power Treads','Phase Boots','Oblivion Staff','Mask of Madness','Hand of Midas','Boots of Travel','Boots of Travel 2','Helm of the Dominator','Moon Shard'],
    ...
    'Броня':['Vanguard','Blade Mail','Aeon Disk','Soul Booster','Crimson Guard','Lotus Orb','Black King Bar','Bloodstone','Hurricane Pike','Manta Style',"Linken's Sphere",'Assault Cuirass',"Shiva's Guard",'Heart of Tarrasque','Consecrated Wraps'],
    ...
    'Артефакты':['Dragon Lance','Kaya','Sange','Yasha','Phylactery','Diffusal Blade','Echo Sabre','Maelstrom',"Heaven's Halberd",'Yasha and Kaya','Kaya and Sange','Sange and Yasha','Harpoon','Satanic','Eye of Skadi','Mjollnir','Arcane Blink','Overwhelming Blink','Swift Blink','Helm of the Overlord']
  };
