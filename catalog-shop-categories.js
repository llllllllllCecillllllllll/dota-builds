(function(){'use strict';
  ...
  var C={
    ...
    'Разное':['Ring of Regen','Sage\'s Mask','Fluffy Hat','Wind Lace','Magic Stick','Boots of Speed','Ring of Health','Void Stone','Voodoo Mask','Cloak','Gem of True Sight','Morbid Mask','Shadow Amulet','Ghost Scepter','Ring of Tarrasque','Tiara of Selemene','Blink Dagger'],
    ...
    'Магия':['Veil of Discord','Glimmer Cape','Force Staff','Rod of Atos','Aether Lens','Eul\'s Scepter','Solar Crest','Witch Blade','Dagon','Dagon 2','Dagon 3','Dagon 4','Dagon 5','Orchid Malevolence','Aghanim\'s Scepter','Octarine Core','Refresher Orb','Scythe of Vyse','Gleipnir','Aghanim\'s Blessing','Wind Waker'],
