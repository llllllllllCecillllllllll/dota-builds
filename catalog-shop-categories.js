(function(){'use strict';
  /* Exact shop taxonomy based on the current Dota 2 Items grid.  Basics: Consumables, Attributes, Equipment, Miscellaneous, Secret Shop.  Upgrades: Accessories, Support, Magical, Armor, Weapons, Artifacts.  Multi-level hidden upgrades remain selectable in their parent category. */
  var C={
    ...
    'Снаряжение':['Quelling Blade','Ring of Protection','Infused Raindrops','Orb of Venom','Blight Stone','Blades of Attack','Gloves of Haste','Chainmail','Javelin','Helm of Iron Will','Blitz Knuckles','Broadsword','Claymore','Mithril Hammer'],
    'Разное':['Ring of Regen',"Sage's Mask",'Fluffy Hat','Wind Lace','Regular Stick','Boots of Speed','Ring of Health','Voodoo Mask','Cloak','Gem of True Sight','Morbid Mask','Shadow Amulet','Ghost Scepter','Ring of Tarrasque','Tiara of Selemene','Blink Dagger'],
    ...
    'Магия':['Veil of Discord','Glimmer Cape','Force Staff','Rod of Atos','Aether Lens',"Eul's Scepter of Divinity",'Solar Crest','Witch Blade','Dagon','Dagon 2','Dagon 3','Dagon 4','Dagon 5','Orchid Malevolence',"Aghanim's Scepter",'Octarine Core','Refresher Orb','Scythe of Vyse','Gleipnir',"Aghanim's Blessing",'Wind Waker'],
