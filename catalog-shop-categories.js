(function(){'use strict';
  /* Current Dota 2 shop taxonomy. Categories follow the in-game shop grouping used by the project. */
  var C={
    'Расходники':['Observer Ward','Observer and Sentry Wards','Blood Grenade','Clarity','Sentry Ward','Smoke of Deceit','Enchanted Mango','Faerie Fire','Dust of Appearance','Tango','Healing Salve','Town Portal Scroll','Bottle',"Aghanim's Shard"],
    ...
    'Снаряжение':['Quelling Blade','Ring of Protection','Infused Raindrops','Orb of Blight','Orb of Frost','Orb of Venom','Blight Stone','Blades of Attack','Gloves of Haste','Chainmail','Javelin','Helm of Iron Will','Blitz Knuckles','Broadsword','Claymore','Mithril Hammer','Splintmail'],
    'Разное':['Ring of Regen',"Sage's Mask",'Fluffy Hat','Wind Lace','Boots of Speed','Ring of Health','Voodoo Mask','Cloak','Gem of True Sight','Morbid Mask','Shadow Amulet','Ghost Scepter','Ring of Tarrasque','Tiara of Selemene','Blink Dagger','Chasm Stone','Shawl','Wizard Hat'],
    ...
    'Аксессуары':['Bracer','Null Talisman','Wraith Band','Magic Wand','Soul Ring','Orb of Corrosion','Falcon Blade','Perseverance','Power Treads','Phase Boots','Oblivion Staff','Mask of Madness','Hand of Midas','Boots of Travel','Boots of Travel 2','Helm of the Dominator','Moon Shard','Helm of the Overlord'],
    'Поддержка':['Buckler','Headdress','Ring of Basilius','Urn of Shadows','Tranquil Boots','Arcane Boots','Pavise','Drum of Endurance','Mekansm',"Vladmir's Offering",'Holy Locket','Spirit Vessel','Essence Distiller','Pipe of Insight','Boots of Bearing','Guardian Greaves'],
    'Магия':['Veil of Discord','Glimmer Cape','Force Staff','Rod of Atos','Aether Lens',"Eul's Scepter of Divinity",'Solar Crest',"Aghanim's Scepter",'Aghanim\'s Blessing','Dagon','Dagon 2','Dagon 3','Dagon 4','Dagon 5','Orchid Malevolence','Octarine Core','Refresher Orb','Scythe of Vyse','Gleipnir','Wind Waker',"Crella's Crozier"],
    'Броня':['Vanguard','Blade Mail','Aeon Disk','Soul Booster','Eternal Shroud','Crimson Guard','Lotus Orb','Black King Bar','Bloodstone','Hurricane Pike','Manta Style',"Linken's Sphere",'Assault Cuirass',"Shiva's Guard",'Heart of Tarrasque','Consecrated Wraps','Helm of the Overlord'],
    'Оружие':['Crystalys','Armlet of Mordiggian','Meteor Hammer','Skull Basher','Shadow Blade','Desolator','Battle Fury','Nullifier','Monkey King Bar','Radiance',"Revenant's Brooch",'Daedalus','Ethereal Blade','Khanda','Butterfly','Silver Edge','Abyssal Blade','Divine Rapier','Disperser','Bloodthorn','Witch Blade','Parasma',"Hydra's Breath","Specialist's Array",'Mage Slayer'],
    'Артефакты':['Dragon Lance','Kaya','Sange','Yasha','Phylactery','Diffusal Blade','Echo Sabre','Maelstrom',"Heaven's Halberd",'Yasha and Kaya','Kaya and Sange','Sange and Yasha','Harpoon','Satanic','Eye of Skadi','Mjollnir','Arcane Blink','Overwhelming Blink','Swift Blink']
  };
