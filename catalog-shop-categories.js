(function(){'use strict';
  ...
  var C={
    ...
    'Оружие':['Crystalys','Meteor Hammer','Armlet of Mordiggian','Skull Basher','Shadow Blade','Desolator','Battle Fury','Ethereal Blade','Nullifier','Monkey King Bar','Butterfly','Radiance','Daedalus','Silver Edge','Divine Rapier','Bloodthorn','Abyssal Blade',"Revenant's Brooch",'Disperser','Khanda','Witch Blade','Parasma',"Hydra's Breath","Specialist's Array",'Mage Slayer'],
    'Артефакты':['Dragon Lance','Sange','Yasha','Kaya','Echo Sabre','Maelstrom','Diffusal Blade','Phylactery','Mage Slayer',"Heaven's Halberd",'Kaya and Sange','Sange and Yasha','Yasha and Kaya','Satanic','Eye of Skadi','Mjollnir','Overwhelming Blink','Swift Blink','Arcane Blink','Harpoon']
  };
